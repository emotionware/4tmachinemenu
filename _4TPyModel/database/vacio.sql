...
Source Database       : 4tempty

Target Server Type    : MariaDB
Target Server Version : 100412
File Encoding         : 65001

Date: 2020-05-13 18:17:15
*/

SET FOREIGN_KEY_CHECKS=0;

-- ----------------------------
-- Table structure for tblaltanotify_tblsyscomponent
-- ----------------------------
DROP TABLE IF EXISTS `tblaltanotify_tblsyscomponent`;
CREATE TABLE `tblaltanotify_tblsyscomponent` (
  `IDALTANOTIFY_tblsyscomponent` int(11) NOT NULL AUTO_INCREMENT,
  `EMAIL` varchar(100) DEFAULT 'NULL',
  PRIMARY KEY (`IDALTANOTIFY_tblsyscomponent`),
  UNIQUE KEY `NOTIFICACION_REPETIDA` (`EMAIL`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;

-- ----------------------------
-- Records of tblaltanotify_tblsyscomponent
-- ----------------------------

-- ----------------------------
-- Table structure for tblconfigcampos_tblsyscomponent
-- ----------------------------
DROP TABLE IF EXISTS `tblconfigcampos_tblsyscomponent`;
CREATE TABLE `tblconfigcampos_tblsyscomponent` (
  `IDCONFIGCAMPOS_tblsyscomponent` int(11) NOT NULL AUTO_INCREMENT,
  `GRUPO` varchar(255) DEFAULT 'A. GENERAL',
  `ORDEN` int(11) DEFAULT 0,
  `CAMPO` varchar(100) DEFAULT NULL,
  `EDITABLE` int(1) DEFAULT 1 COMMENT 'CHECKBOX',
  ...
  `CAPTION` varchar(200) DEFAULT NULL,
  `MOSTRARGRID` int(11) DEFAULT 0 COMMENT 'CHECKBOX',
  PRIMARY KEY (`IDCONFIGCAMPOS_tblsyscomponent`),
  UNIQUE KEY `CAMPONOREPETIBLE` (`CAMPO`)
) ENGINE=InnoDB AUTO_INCREMENT=1151 DEFAULT CHARSET=utf8;

-- ----------------------------
-- Records of tblconfigcampos_tblsyscomponent
-- ----------------------------
INSERT INTO `tblconfigcampos_tblsyscomponent` VALUES ('1', 'A. DATOS', '-10000', 'IDSYSCOMPONENT', '0', '1', '0', '250', '25', '', '', 'Id', '0');
INSERT INTO `tblconfigcampos_tblsyscomponent` VALUES ('2', 'A. DATOS', '0', 'COMPONENTE', '1', '1', '0', '250', '25', '', '', 'Componente', '0');
INSERT INTO `tblconfigcampos_tblsyscomponent` VALUES ('3', 'A. DATOS', '0', 'TEMPLATE', '1', '0', '0', '450', '100', '', 'memo', 'Template', '0');
INSERT INTO `tblconfigcampos_tblsyscomponent` VALUES ('7', 'A. DATOS', '0', 'AUXILIAR1_char', '1', '0', '0', '250', '25', '', 'texto', 'Auxiliar1_Char', '0');
INSERT INTO `tblconfigcampos_tblsyscomponent` VALUES ('8', 'A. DATOS', '0', 'AUXILIAR2_char', '1', '0', '0', '250', '25', '', 'texto', 'Auxiliar2_Char', '0');
INSERT INTO `tblconfigcampos_tblsyscomponent` VALUES ('9', 'A. DATOS', '0', 'AUXILIAR1_Memo', '1', '0', '0', '250', '100', '', 'memo', 'Auxiliar1_Memo', '0');
INSERT INTO `tblconfigcampos_tblsyscomponent` VALUES ('10', 'A. DATOS', '0', 'AUXILIAR2_Memo', '1', '0', '0', '250', '100', '', 'memo', 'Auxiliar2_Memo', '0');
INSERT INTO `tblconfigcampos_tblsyscomponent` VALUES ('11', 'A. DATOS', '0', 'AUXILIAR1_Check', '1', '0', '0', '250', '25', '', 'checkbox', 'Auxiliar1_Check', '0');
INSERT INTO `tblconfigcampos_tblsyscomponent` VALUES ('12', 'A. DATOS', '0', 'AUXILIAR2_Check', '1', '0', '0', '250', '25', '', 'checkbox', 'Auxiliar2_Check', '0');
INSERT INTO `tblconfigcampos_tblsyscomponent` VALUES ('13', 'A. DATOS', '0', 'AUXILIAR1_date', '1', '0', '0', '250', '25', '', 'date', 'Auxiliar1_Date', '0');
INSERT INTO `tblconfigcampos_tblsyscomponent` VALUES ('14', 'A. DATOS', '0', 'AUXILIAR1_time', '1', '0', '0', '250', '25', '', 'time', 'Auxiliar1_Time', '0');
INSERT INTO `tblconfigcampos_tblsyscomponent` VALUES ('15', 'A. DATOS', '0', 'AUXILIAR1_decimal', '1', '0', '0', '250', '25', '', 'money', 'Auxiliar1_Decimal', '0');
INSERT INTO `tblconfigcampos_tblsyscomponent` VALUES ('16', 'A. DATOS', '0', 'AUXILIAR2_decimal', '1', '0', '0', '250', '25', '', 'money', 'Auxiliar2_Decimal', '0');
INSERT INTO `tblconfigcampos_tblsyscomponent` VALUES ('17', 'A. DATOS', '0', 'OBSERVACIONES', '1', '1', '0', '250', '100', '', 'memo', 'Observaciones', '0');
INSERT INTO `tblconfigcampos_tblsyscomponent` VALUES ('18', 'X. CONTROL', '-10000', 'ELIMINADO', '0', '1', '0', '250', '25', '', 'checkbox', 'Eliminado', '0');
INSERT INTO `tblconfigcampos_tblsyscomponent` VALUES ('19', 'A. DATOS', '-10000', 'CREADOR', '0', '0', '0', '250', '25', '', 'texto', 'Creador', '0');
INSERT INTO `tblconfigcampos_tblsyscomponent` VALUES ('20', 'X. CONTROL', '-10000', 'BLOQUEADO', '0', '1', '0', '250', '25', '', 'checkbox', 'Bloqueado', '0');
INSERT INTO `tblconfigcampos_tblsyscomponent` VALUES ('21', 'A. DATOS', '0', 'GUID', '1', '0', '0', '250', '25', '', 'texto', 'Guid', '0');
INSERT INTO `tblconfigcampos_tblsyscomponent` VALUES ('22', 'X. CONTROL', '0', 'PROPIETARIO', '1', '1', '0', '250', '25', '', 'texto', 'Propietario', '0');
INSERT INTO `tblconfigcampos_tblsyscomponent` VALUES ('23', 'A. DATOS', '0', 'CAMPODISPLAY', '1', '0', '0', '250', '25', '', 'texto', 'Campodisplay', '0');
INSERT INTO `tblconfigcampos_tblsyscomponent` VALUES ('24', 'X. CONTROL', '-10000', 'FECHAALTA', '0', '1', '0', '250', '25', '', 'date', 'Fecha Alta', '0');
INSERT INTO `tblconfigcampos_tblsyscomponent` VALUES ('25', 'A. DATOS', '0', 'FECHAMODIFICACION', '1', '0', '0', '250', '25', '', 'date', 'Fechamodificacion', '0');
INSERT INTO `tblconfigcampos_tblsyscomponent` VALUES ('26', 'A. DATOS', '0', 'HORAMODIFICACION', '1', '0', '0', '250', '25', '', 'time', 'Horamodificacion', '0');
INSERT INTO `tblconfigcampos_tblsyscomponent` VALUES ('27', 'A. DATOS', '0', 'IMAGENADJUNTA', '1', '0', '0', '250', '25', '', 'texto', 'Imagenadjunta', '0');
INSERT INTO `tblconfigcampos_tblsyscomponent` VALUES ('28', 'A. DATOS', '0', 'ULTIMOUSUARIO', '1', '0', '0', '250', '25', '', 'texto', 'Ultimousuario', '0');
INSERT INTO `tblconfigcampos_tblsyscomponent` VALUES ('29', 'A. DATOS', '0', 'IDESTATUS_tblsyscomponent', '1', '0', '0', '250', '25', 'PULSAR ESPACIO EN EL CAMPO PARA MOSTRAR OPCIONES', '*', 'Idestatus_Tblsyscomponent', '0');
INSERT INTO `tblconfigcampos_tblsyscomponent` VALUES ('371', 'A. DATOS', '0', 'ARRIBA', '1', '0', '0', '250', '25', '', 'checkbox', 'Arriba', '0');
INSERT INTO `tblconfigcampos_tblsyscomponent` VALUES ('372', 'A. DATOS', '0', 'ENMEDIO', '1', '0', '0', '250', '25', '', 'checkbox', 'Enmedio', '0');
INSERT INTO `tblconfigcampos_tblsyscomponent` VALUES ('373', 'A. DATOS', '0', 'ABAJO', '1', '0', '0', '250', '25', '', 'checkbox', 'Abajo', '0');

-- ----------------------------
-- Table structure for tblestatus_tblsyscomponent
-- ----------------------------
DROP TABLE IF EXISTS `tblestatus_tblsyscomponent`;
CREATE TABLE `tblestatus_tblsyscomponent` (
  `IDESTATUS_tblsyscomponent` int(11) NOT NULL AUTO_INCREMENT,
  `CAMPODISPLAY` varchar(80) DEFAULT 'NULL',
  PRIMARY KEY (`IDESTATUS_tblsyscomponent`),
  UNIQUE KEY `CAMPONOREPETIBLE` (`CAMPODISPLAY`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;

-- ----------------------------
-- Records of tblestatus_tblsyscomponent
-- ----------------------------

-- ----------------------------
-- Table structure for tblestatusnotify_tblsyscomponent
-- ----------------------------
DROP TABLE IF EXISTS `tblestatusnotify_tblsyscomponent`;
CREATE TABLE `tblestatusnotify_tblsyscomponent` (
  `IDESTATUSNOTIFY_tblsyscomponent` int(11) NOT NULL AUTO_INCREMENT,
  `ESTATUS` varchar(80) DEFAULT 'NULL',
  `EMAIL` varchar(100) DEFAULT 'NULL',
  PRIMARY KEY (`IDESTATUSNOTIFY_tblsyscomponent`),
  UNIQUE KEY `NOTIFICACION_REPETIDA` (`ESTATUS`,`EMAIL`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;

-- ----------------------------
-- Records of tblestatusnotify_tblsyscomponent
-- ----------------------------

-- ----------------------------
-- Table structure for tblsyscomponent
-- ----------------------------
DROP TABLE IF EXISTS `tblsyscomponent`;
CREATE TABLE `tblsyscomponent` (
  `IDSYSCOMPONENT` int(11) NOT NULL AUTO_INCREMENT,
  `COMPONENTE` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `TEMPLATE` longtext COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT 'memo',
  `ARRIBA` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT 'checkbox',
  `ENMEDIO` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT 'checkbox',
  `ABAJO` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT 'checkbox',
  `AUXILIAR1_char` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT 'texto',
  `AUXILIAR2_char` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT 'texto',
  `AUXILIAR1_Memo` varchar(400) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT 'memo',
  `AUXILIAR2_Memo` varchar(400) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT 'memo',
  `AUXILIAR1_Check` varchar(10) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT 'checkbox',
  `AUXILIAR2_Check` varchar(10) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT 'checkbox',
  `AUXILIAR1_date` date DEFAULT NULL COMMENT 'date',
  `AUXILIAR1_time` varchar(50) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT 'time',
  `AUXILIAR1_decimal` double(12,2) DEFAULT NULL COMMENT 'money',
  `AUXILIAR2_decimal` double(12,2) DEFAULT NULL COMMENT 'money',
  `OBSERVACIONES` varchar(400) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT 'memo',
  `ELIMINADO` varchar(10) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT 'checkbox',
  `CREADOR` varchar(40) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT 'texto',
  `BLOQUEADO` varchar(10) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT 'checkbox',
  `GUID` varchar(50) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT 'texto',
  `PROPIETARIO` varchar(50) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT 'texto',
  `CAMPODISPLAY` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT 'texto',
  `FECHAALTA` date DEFAULT NULL COMMENT 'date',
  `FECHAMODIFICACION` date DEFAULT NULL COMMENT 'date',
  `HORAMODIFICACION` varchar(50) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT 'time',
  `IMAGENADJUNTA` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT 'texto',
  `ULTIMOUSUARIO` varchar(40) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT 'texto',
  `IDESTATUS_tblsyscomponent` int(11) DEFAULT NULL COMMENT '*',
  PRIMARY KEY (`IDSYSCOMPONENT`)
) ENGINE=InnoDB AUTO_INCREMENT=7 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;

-- ----------------------------
-- Records of tblsyscomponent
-- ----------------------------
INSERT INTO `tblsyscomponent` VALUES ('2', 'AudioPlayer', null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, 'false', 'root@localhost', 'false', '40c6b288-9527-11ea-97c9-f191035abb9a', '1', ' 2--AudioPlayer--', '2020-05-13', '2020-05-13', '09:37:21', null, 'admin', null);
INSERT INTO `tblsyscomponent` VALUES ('3', 'Iframe', null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, 'false', 'root@localhost', 'false', '54dc41eb-9527-11ea-97c9-f191035abb9a', '1', ' 3--Iframe--', '2020-05-13', '2020-05-13', '09:37:54', null, 'admin', null);
INSERT INTO `tblsyscomponent` VALUES ('4', 'Link', null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, 'false', 'root@localhost', 'false', '576e4c9c-9527-11ea-97c9-f191035abb9a', '1', ' 4--Link--', '2020-05-13', '2020-05-13', '09:37:59', null, 'admin', null);
INSERT INTO `tblsyscomponent` VALUES ('6', 'Botón', null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, 'false', 'root@localhost', 'false', '6126b787-9546-11ea-97c9-f191035abb9a', '1', ' 6--Botón--', '2020-05-13', '2020-05-13', '13:20:09', null, 'admin', null);

-- ----------------------------
-- Table structure for tblsyscomponent_history
-- ----------------------------
DROP TABLE IF EXISTS `tblsyscomponent_history`;
CREATE TABLE `tblsyscomponent_history` (
  `IDSYSCOMPONENT` int(11) DEFAULT NULL,
  `COMPONENTE` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `TEMPLATE` longtext COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT 'memo',
  `ARRIBA` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT 'checkbox',
  `ENMEDIO` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT 'checkbox',
...
-- ----------------------------
-- Records of tblsyscomponent_history
-- ----------------------------
INSERT INTO `tblsyscomponent_history` VALUES ('5', 'Password', null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, 'true', 'root@localhost', 'false', '5a2939ed-9527-11ea-97c9-f191035abb9a', '1', ' 5--Password--', '2020-05-13', '2020-05-13', '09:38:03', null, 'admin', null);
INSERT INTO `tblsyscomponent_history` VALUES ('5', 'Password', null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, 'true', 'root@localhost', 'false', '5a2939ed-9527-11ea-97c9-f191035abb9a', '1', ' 5--Password--', '2020-05-13', '2020-05-13', '17:41:36', null, 'admin', null);
INSERT INTO `tblsyscomponent_history` VALUES ('2', 'AudioPlayer', null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, 'true', 'root@localhost', 'false', '40c6b288-9527-11ea-97c9-f191035abb9a', '1', ' 2--AudioPlayer--', '2020-05-13', '2020-05-13', '09:37:21', null, 'admin', null);

-- ----------------------------
-- Table structure for tblsyscomponent_history_deleted
-- ----------------------------
DROP TABLE IF EXISTS `tblsyscomponent_history_deleted`;
CREATE TABLE `tblsyscomponent_history_deleted` (
  `IDSYSCOMPONENT` int(11) DEFAULT NULL,
  `COMPONENTE` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `TEMPLATE` longtext COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT 'memo',
  `ARRIBA` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT 'checkbox',
...
-- ----------------------------
-- Records of tblsyscomponent_history_deleted
-- ----------------------------
INSERT INTO `tblsyscomponent_history_deleted` VALUES ('5', 'Password', null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, 'true', 'root@localhost', 'false', '5a2939ed-9527-11ea-97c9-f191035abb9a', '1', ' 5--Password--', '2020-05-13', '2020-05-13', '17:41:36', null, 'admin', null);
DROP TRIGGER IF EXISTS `tblestatus_tblsyscomponent_BI`;
DELIMITER ;;
CREATE TRIGGER `tblestatus_tblsyscomponent_BI` BEFORE INSERT ON `tblestatus_tblsyscomponent` FOR EACH ROW BEGIN
 Set New.CAMPODISPLAY := CONCAT(' ',New.CAMPODISPLAY);
End
;;
DELIMITER ;
DROP TRIGGER IF EXISTS `tblestatus_tblsyscomponent_BU`;
DELIMITER ;;
CREATE TRIGGER `tblestatus_tblsyscomponent_BU` BEFORE UPDATE ON `tblestatus_tblsyscomponent` FOR EACH ROW BEGIN
 Set New.CAMPODISPLAY := CONCAT(' ',New.CAMPODISPLAY);
End
;;
DELIMITER ;
DROP TRIGGER IF EXISTS `tblsyscomponent_BI`;
DELIMITER ;;
CREATE TRIGGER `tblsyscomponent_BI` BEFORE INSERT ON `tblsyscomponent` FOR EACH ROW BEGIN
Set New.FECHAMODIFICACION := now();
Set New.GUID := UUID();
Set New.CREADOR := USER();
Set New.FECHAALTA := now();
...
;;
DELIMITER ;
DROP TRIGGER IF EXISTS `tblsyscomponent_trigger_insert`;
DELIMITER ;;
CREATE TRIGGER `tblsyscomponent_trigger_insert` AFTER INSERT ON `tblsyscomponent` FOR EACH ROW BEGIN
  INSERT IGNORE  INTO  tblsyscomponent_history SELECT * FROM  tblsyscomponent WHERE  IDSYSCOMPONENT = NEW. IDSYSCOMPONENT;
End
;;
DELIMITER ;
DROP TRIGGER IF EXISTS `tblsyscomponent_trigger_update`;
DELIMITER ;;
CREATE TRIGGER `tblsyscomponent_trigger_update` AFTER UPDATE ON `tblsyscomponent` FOR EACH ROW BEGIN
  INSERT IGNORE  INTO  tblsyscomponent_history   SELECT * FROM  tblsyscomponent   WHERE   IDSYSCOMPONENT = NEW. IDSYSCOMPONENT;
End
;;
DELIMITER ;
DROP TRIGGER IF EXISTS `tblsyscomponent_trigger_delete`;
DELIMITER ;;
CREATE TRIGGER `tblsyscomponent_trigger_delete` BEFORE DELETE ON `tblsyscomponent` FOR EACH ROW BEGIN
  INSERT IGNORE  INTO  tblsyscomponent_history_deleted SELECT * FROM  tblsyscomponent WHERE  IDSYSCOMPONENT = OLD. IDSYSCOMPONENT;
End
;;
DELIMITER ;
...
Date: 2020-05-13 18:17:29
*/

SET FOREIGN_KEY_CHECKS=0;

-- ----------------------------
-- Table structure for tblaltanotify_tblincrustador
-- ----------------------------
DROP TABLE IF EXISTS `tblaltanotify_tblincrustador`;
CREATE TABLE `tblaltanotify_tblincrustador` (
  `IDALTANOTIFY_tblincrustador` int(11) NOT NULL AUTO_INCREMENT,
  `EMAIL` varchar(100) DEFAULT 'NULL',
  PRIMARY KEY (`IDALTANOTIFY_tblincrustador`),
  UNIQUE KEY `NOTIFICACION_REPETIDA` (`EMAIL`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;

-- ----------------------------
-- Records of tblaltanotify_tblincrustador
-- ----------------------------

-- ----------------------------
-- Table structure for tblconfigcampos_tblincrustador
-- ----------------------------
DROP TABLE IF EXISTS `tblconfigcampos_tblincrustador`;
CREATE TABLE `tblconfigcampos_tblincrustador` (
  `IDCONFIGCAMPOS_tblincrustador` int(11) NOT NULL AUTO_INCREMENT,
  `GRUPO` varchar(255) DEFAULT 'A. GENERAL',
  `ORDEN` int(11) DEFAULT 0,
  `CAMPO` varchar(100) DEFAULT NULL,
  `EDITABLE` int(1) DEFAULT 1 COMMENT 'CHECKBOX',
  ...
  `CAPTION` varchar(200) DEFAULT NULL,
  `MOSTRARGRID` int(11) DEFAULT 0 COMMENT 'CHECKBOX',
  PRIMARY KEY (`IDCONFIGCAMPOS_tblincrustador`),
  UNIQUE KEY `CAMPONOREPETIBLE` (`CAMPO`)
) ENGINE=InnoDB AUTO_INCREMENT=2444 DEFAULT CHARSET=utf8;

-- ----------------------------
-- Records of tblconfigcampos_tblincrustador
-- ----------------------------
INSERT INTO `tblconfigcampos_tblincrustador` VALUES ('1', 'A. DATOS', '-10000', 'IDINCRUSTADOR', '0', '1', '0', '250', '25', '', '', 'Id', '0');
INSERT INTO `tblconfigcampos_tblincrustador` VALUES ('2', 'A. DATOS', '0', 'IDSYSCOMPONENT', '1', '1', '0', '250', '25', 'PULSAR ESPACIO EN EL CAMPO PARA MOSTRAR OPCIONES', '*', 'Component', '0');
INSERT INTO `tblconfigcampos_tblincrustador` VALUES ('3', 'A. DATOS', '0', 'TABLA', '1', '1', '0', '250', '25', '', '', 'Tabla', '0');
INSERT INTO `tblconfigcampos_tblincrustador` VALUES ('4', 'A. DATOS', '0', 'CAMPO', '1', '1', '0', '250', '25', '', '', 'Campo', '0');
INSERT INTO `tblconfigcampos_tblincrustador` VALUES ('9', 'A. DATOS', '0', 'AUXILIAR1_char', '1', '0', '0', '250', '25', '', 'texto', 'Auxiliar1_Char', '0');
INSERT INTO `tblconfigcampos_tblincrustador` VALUES ('10', 'A. DATOS', '0', 'AUXILIAR2_char', '1', '0', '0', '250', '25', '', 'texto', 'Auxiliar2_Char', '0');
INSERT INTO `tblconfigcampos_tblincrustador` VALUES ('11', 'A. DATOS', '0', 'AUXILIAR1_Memo', '1', '0', '0', '250', '100', '', 'memo', 'Auxiliar1_Memo', '0');
INSERT INTO `tblconfigcampos_tblincrustador` VALUES ('12', 'A. DATOS', '0', 'AUXILIAR2_Memo', '1', '0', '0', '250', '100', '', 'memo', 'Auxiliar2_Memo', '0');
INSERT INTO `tblconfigcampos_tblincrustador` VALUES ('13', 'A. DATOS', '0', 'AUXILIAR1_Check', '1', '0', '0', '250', '25', '', 'checkbox', 'Auxiliar1_Check', '0');
INSERT INTO `tblconfigcampos_tblincrustador` VALUES ('14', 'A. DATOS', '0', 'AUXILIAR2_Check', '1', '0', '0', '250', '25', '', 'checkbox', 'Auxiliar2_Check', '0');
INSERT INTO `tblconfigcampos_tblincrustador` VALUES ('15', 'A. DATOS', '0', 'AUXILIAR1_date', '1', '0', '0', '250', '25', '', 'date', 'Auxiliar1_Date', '0');
INSERT INTO `tblconfigcampos_tblincrustador` VALUES ('16', 'A. DATOS', '0', 'AUXILIAR1_time', '1', '0', '0', '250', '25', '', 'time', 'Auxiliar1_Time', '0');
INSERT INTO `tblconfigcampos_tblincrustador` VALUES ('17', 'A. DATOS', '0', 'AUXILIAR1_decimal', '1', '0', '0', '250', '25', '', 'money', 'Auxiliar1_Decimal', '0');
INSERT INTO `tblconfigcampos_tblincrustador` VALUES ('18', 'A. DATOS', '0', 'AUXILIAR2_decimal', '1', '0', '0', '250', '25', '', 'money', 'Auxiliar2_Decimal', '0');
INSERT INTO `tblconfigcampos_tblincrustador` VALUES ('19', 'A. DATOS', '3000', 'OBSERVACIONES', '1', '1', '0', '250', '100', '', 'memo', 'Observaciones', '0');
INSERT INTO `tblconfigcampos_tblincrustador` VALUES ('20', 'X. CONTROL', '-10000', 'ELIMINADO', '0', '1', '0', '250', '25', '', 'checkbox', 'Eliminado', '0');
INSERT INTO `tblconfigcampos_tblincrustador` VALUES ('21', 'A. DATOS', '-10000', 'CREADOR', '0', '0', '0', '250', '25', '', 'texto', 'Creador', '0');
INSERT INTO `tblconfigcampos_tblincrustador` VALUES ('22', 'X. CONTROL', '-10000', 'BLOQUEADO', '0', '1', '0', '250', '25', '', 'checkbox', 'Bloqueado', '0');
INSERT INTO `tblconfigcampos_tblincrustador` VALUES ('23', 'A. DATOS', '0', 'GUID', '1', '0', '0', '250', '25', '', 'texto', 'Guid', '0');
INSERT INTO `tblconfigcampos_tblincrustador` VALUES ('24', 'X. CONTROL', '0', 'PROPIETARIO', '1', '1', '0', '250', '25', '', 'texto', 'Propietario', '0');
INSERT INTO `tblconfigcampos_tblincrustador` VALUES ('25', 'A. DATOS', '0', 'CAMPODISPLAY', '1', '0', '0', '250', '25', '', 'texto', 'Campodisplay', '0');
INSERT INTO `tblconfigcampos_tblincrustador` VALUES ('26', 'X. CONTROL', '-10000', 'FECHAALTA', '0', '1', '0', '250', '25', '', 'date', 'Fecha Alta', '0');
INSERT INTO `tblconfigcampos_tblincrustador` VALUES ('27', 'A. DATOS', '0', 'FECHAMODIFICACION', '1', '0', '0', '250', '25', '', 'date', 'Fechamodificacion', '0');
INSERT INTO `tblconfigcampos_tblincrustador` VALUES ('28', 'A. DATOS', '0', 'HORAMODIFICACION', '1', '0', '0', '250', '25', '', 'time', 'Horamodificacion', '0');
INSERT INTO `tblconfigcampos_tblincrustador` VALUES ('29', 'A. DATOS', '0', 'IMAGENADJUNTA', '1', '0', '0', '250', '25', '', 'texto', 'Imagenadjunta', '0');
INSERT INTO `tblconfigcampos_tblincrustador` VALUES ('30', 'A. DATOS', '0', 'ULTIMOUSUARIO', '1', '0', '0', '250', '25', '', 'texto', 'Ultimousuario', '0');
INSERT INTO `tblconfigcampos_tblincrustador` VALUES ('31', 'A. DATOS', '0', 'IDESTATUS_tblincrustador', '1', '0', '0', '250', '25', 'PULSAR ESPACIO EN EL CAMPO PARA MOSTRAR OPCIONES', '*', 'Idestatus_Tblincrustador', '0');
INSERT INTO `tblconfigcampos_tblincrustador` VALUES ('198', 'A. DATOS', '0', 'ARRIBA', '1', '1', '0', '250', '25', '', 'checkbox', 'Arriba', '0');
INSERT INTO `tblconfigcampos_tblincrustador` VALUES ('199', 'A. DATOS', '0', 'ENMEDIO', '1', '1', '0', '250', '25', '', 'checkbox', 'Enmedio', '0');
INSERT INTO `tblconfigcampos_tblincrustador` VALUES ('200', 'A. DATOS', '0', 'ABAJO', '1', '1', '0', '250', '25', '', 'checkbox', 'Abajo', '0');

-- ----------------------------
-- Table structure for tblestatus_tblincrustador
-- ----------------------------
DROP TABLE IF EXISTS `tblestatus_tblincrustador`;
CREATE TABLE `tblestatus_tblincrustador` (
  `IDESTATUS_tblincrustador` int(11) NOT NULL AUTO_INCREMENT,
  `CAMPODISPLAY` varchar(80) DEFAULT 'NULL',
  PRIMARY KEY (`IDESTATUS_tblincrustador`),
  UNIQUE KEY `CAMPONOREPETIBLE` (`CAMPODISPLAY`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;

-- ----------------------------
-- Records of tblestatus_tblincrustador
-- ----------------------------

-- ----------------------------
-- Table structure for tblestatusnotify_tblincrustador
-- ----------------------------
DROP TABLE IF EXISTS `tblestatusnotify_tblincrustador`;
CREATE TABLE `tblestatusnotify_tblincrustador` (
  `IDESTATUSNOTIFY_tblincrustador` int(11) NOT NULL AUTO_INCREMENT,
  `ESTATUS` varchar(80) DEFAULT 'NULL',
  `EMAIL` varchar(100) DEFAULT 'NULL',
  PRIMARY KEY (`IDESTATUSNOTIFY_tblincrustador`),
  UNIQUE KEY `NOTIFICACION_REPETIDA` (`ESTATUS`,`EMAIL`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;

-- ----------------------------
-- Records of tblestatusnotify_tblincrustador
-- ----------------------------

-- ----------------------------
-- Table structure for tblincrustador
-- ----------------------------
DROP TABLE IF EXISTS `tblincrustador`;
CREATE TABLE `tblincrustador` (
  `IDINCRUSTADOR` int(11) NOT NULL AUTO_INCREMENT,
  `IDSYSCOMPONENT` int(11) DEFAULT NULL COMMENT '*',
  `TABLA` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `CAMPO` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `ARRIBA` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT '' COMMENT 'checkbox',
  `ENMEDIO` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT '' COMMENT 'checkbox',
  `ABAJO` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT '' COMMENT 'checkbox',
  `AUXILIAR1_char` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT 'texto',
  `AUXILIAR2_char` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT 'texto',
  `AUXILIAR1_Memo` varchar(400) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT 'memo',
  `AUXILIAR2_Memo` varchar(400) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT 'memo',
  ...
  `IMAGENADJUNTA` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT 'texto',
  `ULTIMOUSUARIO` varchar(40) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT 'texto',
  `IDESTATUS_tblincrustador` int(11) DEFAULT NULL COMMENT '*',
  PRIMARY KEY (`IDINCRUSTADOR`)
) ENGINE=InnoDB AUTO_INCREMENT=2 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;

-- ----------------------------
-- Records of tblincrustador
-- ----------------------------
INSERT INTO `tblincrustador` VALUES ('1', '3', 'tblincrustador', 'ABAJO', 'false', 'false', 'true', null, null, null, null, null, null, null, null, null, null, null, 'false', 'root@localhost', 'false', 'cee84289-9528-11ea-97c9-f191035abb9a', '1', ' 1--3-tblincrustador-ABAJO', '2020-05-13', '2020-05-13', '18:15:00', null, 'admin', null);

-- ----------------------------
-- Table structure for tblincrustador_history
-- ----------------------------
DROP TABLE IF EXISTS `tblincrustador_history`;
CREATE TABLE `tblincrustador_history` (
  `IDINCRUSTADOR` int(11) DEFAULT NULL,
  `IDSYSCOMPONENT` int(11) DEFAULT NULL COMMENT '*',
  `TABLA` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `CAMPO` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `ARRIBA` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT '' COMMENT 'checkbox',
...
-- ----------------------------
-- Records of tblincrustador_history
-- ----------------------------

-- ----------------------------
-- Table structure for tblincrustador_history_deleted
-- ----------------------------
DROP TABLE IF EXISTS `tblincrustador_history_deleted`;
CREATE TABLE `tblincrustador_history_deleted` (
  `IDINCRUSTADOR` int(11) DEFAULT NULL,
  `IDSYSCOMPONENT` int(11) DEFAULT NULL COMMENT '*',
  `TABLA` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `CAMPO` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
-- ----------------------------
-- Records of tblincrustador_history_deleted
-- ----------------------------
DROP TRIGGER IF EXISTS `tblestatus_tblincrustador_BI`;
DELIMITER ;;
CREATE TRIGGER `tblestatus_tblincrustador_BI` BEFORE INSERT ON `tblestatus_tblincrustador` FOR EACH ROW BEGIN
 Set New.CAMPODISPLAY := CONCAT(' ',New.CAMPODISPLAY);
End
;;
DELIMITER ;
DROP TRIGGER IF EXISTS `tblestatus_tblincrustador_BU`;
DELIMITER ;;
CREATE TRIGGER `tblestatus_tblincrustador_BU` BEFORE UPDATE ON `tblestatus_tblincrustador` FOR EACH ROW BEGIN
 Set New.CAMPODISPLAY := CONCAT(' ',New.CAMPODISPLAY);
End
;;
DELIMITER ;
DROP TRIGGER IF EXISTS `tblincrustador_BI`;
DELIMITER ;;
CREATE TRIGGER `tblincrustador_BI` BEFORE INSERT ON `tblincrustador` FOR EACH ROW BEGIN
Set New.FECHAMODIFICACION := now();
Set New.GUID := UUID();
Set New.CREADOR := USER();
Set New.FECHAALTA := now();
...
;;
DELIMITER ;
DROP TRIGGER IF EXISTS `tblincrustador_trigger_insert`;
DELIMITER ;;
CREATE TRIGGER `tblincrustador_trigger_insert` AFTER INSERT ON `tblincrustador` FOR EACH ROW BEGIN
  INSERT IGNORE  INTO  tblincrustador_history SELECT * FROM  tblincrustador WHERE  IDINCRUSTADOR = NEW. IDINCRUSTADOR;
End
;;
DELIMITER ;
DROP TRIGGER IF EXISTS `tblincrustador_trigger_update`;
DELIMITER ;;
CREATE TRIGGER `tblincrustador_trigger_update` AFTER UPDATE ON `tblincrustador` FOR EACH ROW BEGIN
  INSERT IGNORE  INTO  tblincrustador_history   SELECT * FROM  tblincrustador   WHERE   IDINCRUSTADOR = NEW. IDINCRUSTADOR;
End
;;
DELIMITER ;
DROP TRIGGER IF EXISTS `tblincrustador_trigger_delete`;
DELIMITER ;;
CREATE TRIGGER `tblincrustador_trigger_delete` BEFORE DELETE ON `tblincrustador` FOR EACH ROW BEGIN
  INSERT IGNORE  INTO  tblincrustador_history_deleted SELECT * FROM  tblincrustador WHERE  IDINCRUSTADOR = OLD. IDINCRUSTADOR;
End
;;
DELIMITER ;
...
/*
MARIADB Backup
Source Server Version: 10.4.12
Source Database: 4tempty
Date: 13/05/2020 18:16:55
*/

SET FOREIGN_KEY_CHECKS=0;

-- ----------------------------
--  View definition for `view_notify_report_tblincrustador`
-- ----------------------------
DROP VIEW IF EXISTS `view_notify_report_tblincrustador`;
CREATE ALGORITHM=UNDEFINED DEFINER=`root`@`localhost` SQL SECURITY DEFINER VIEW `view_notify_report_tblincrustador` AS select `tblincrustador`.`IDINCRUSTADOR` AS `IDINCRUSTADOR`,`tblincrustador`.`IDSYSCOMPONENT` AS `IDSYSCOMPONENT`,`tblincrustador`.`TABLA` AS `TABLA`,`tblincrustador`.`CAMPO` AS `CAMPO`,`tblincrustador`.`AUXILIAR1_char` AS `AUXILIAR1_char`,`tblincrustador`.`AUXILIAR2_char` AS `AUXILIAR2_char`,`tblincrustador`.`AUXILIAR1_Memo` AS `AUXILIAR1_Memo`,`tblincrustador`.`AUXILIAR2_Memo` AS `AUXILIAR2_Memo`,`tblincrustador`.`AUXILIAR1_Check` AS `AUXILIAR1_Check`,`tblincrustador`.`AUXILIAR2_Check` AS `AUXILIAR2_Check`,`tblincrustador`.`AUXILIAR1_date` AS `AUXILIAR1_date`,`tblincrustador`.`AUXILIAR1_time` AS `AUXILIAR1_time`,`tblincrustador`.`AUXILIAR1_decimal` AS `AUXILIAR1_decimal`,`tblincrustador`.`AUXILIAR2_decimal` AS `AUXILIAR2_decimal`,`tblincrustador`.`OBSERVACIONES` AS `OBSERVACIONES`,`tblincrustador`.`ELIMINADO` AS `ELIMINADO`,`tblincrustador`.`CREADOR` AS `CREADOR`,`tblincrustador`.`BLOQUEADO` AS `BLOQUEADO`,`tblincrustador`.`GUID` AS `GUID`,`tblincrustador`.`PROPIETARIO` AS `PROPIETARIO`,`tblincrustador`.`CAMPODISPLAY` AS `CAMPODISPLAY`,`tblincrustador`.`FECHAALTA` AS `FECHAALTA`,`tblincrustador`.`FECHAMODIFICACION` AS `FECHAMODIFICACION`,`tblincrustador`.`HORAMODIFICACION` AS `HORAMODIFICACION`,`tblincrustador`.`IMAGENADJUNTA` AS `IMAGENADJUNTA`,`tblincrustador`.`ULTIMOUSUARIO` AS `ULTIMOUSUARIO`,`tblincrustador`.`IDESTATUS_tblincrustador` AS `IDESTATUS_tblincrustador` from `tblincrustador`;

-- ----------------------------
--  View definition for `view_notify_report_tblsyscomponent`
-- ----------------------------
DROP VIEW IF EXISTS `view_notify_report_tblsyscomponent`;
CREATE ALGORITHM=UNDEFINED DEFINER=`root`@`localhost` SQL SECURITY DEFINER VIEW `view_notify_report_tblsyscomponent` AS select `tblsyscomponent`.`IDSYSCOMPONENT` AS `IDSYSCOMPONENT`,`tblsyscomponent`.`COMPONENTE` AS `COMPONENTE`,`tblsyscomponent`.`TEMPLATE` AS `TEMPLATE`,`tblsyscomponent`.`AUXILIAR1_char` AS `AUXILIAR1_char`,`tblsyscomponent`.`AUXILIAR2_char` AS `AUXILIAR2_char`,`tblsyscomponent`.`AUXILIAR1_Memo` AS `AUXILIAR1_Memo`,`tblsyscomponent`.`AUXILIAR2_Memo` AS `AUXILIAR2_Memo`,`tblsyscomponent`.`AUXILIAR1_Check` AS `AUXILIAR1_Check`,`tblsyscomponent`.`AUXILIAR2_Check` AS `AUXILIAR2_Check`,`tblsyscomponent`.`AUXILIAR1_date` AS `AUXILIAR1_date`,`tblsyscomponent`.`AUXILIAR1_time` AS `AUXILIAR1_time`,`tblsyscomponent`.`AUXILIAR1_decimal` AS `AUXILIAR1_decimal`,`tblsyscomponent`.`AUXILIAR2_decimal` AS `AUXILIAR2_decimal`,`tblsyscomponent`.`OBSERVACIONES` AS `OBSERVACIONES`,`tblsyscomponent`.`ELIMINADO` AS `ELIMINADO`,`tblsyscomponent`.`CREADOR` AS `CREADOR`,`tblsyscomponent`.`BLOQUEADO` AS `BLOQUEADO`,`tblsyscomponent`.`GUID` AS `GUID`,`tblsyscomponent`.`PROPIETARIO` AS `PROPIETARIO`,`tblsyscomponent`.`CAMPODISPLAY` AS `CAMPODISPLAY`,`tblsyscomponent`.`FECHAALTA` AS `FECHAALTA`,`tblsyscomponent`.`FECHAMODIFICACION` AS `FECHAMODIFICACION`,`tblsyscomponent`.`HORAMODIFICACION` AS `HORAMODIFICACION`,`tblsyscomponent`.`IMAGENADJUNTA` AS `IMAGENADJUNTA`,`tblsyscomponent`.`ULTIMOUSUARIO` AS `ULTIMOUSUARIO`,`tblsyscomponent`.`IDESTATUS_tblsyscomponent` AS `IDESTATUS_tblsyscomponent` from `tblsyscomponent`;

-- ----------------------------
--  Procedure definition for `tblincrustador_PROC_AFTER_INSERT`
-- ----------------------------
DROP PROCEDURE IF EXISTS `tblincrustador_PROC_AFTER_INSERT`;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `tblincrustador_PROC_AFTER_INSERT`(IN _id INT(11))
BEGIN
 END
;;
DELIMITER ;
...
-- ----------------------------
--  Procedure definition for `tblincrustador_PROC_AFTER_UPDATE`
-- ----------------------------
DROP PROCEDURE IF EXISTS `tblincrustador_PROC_AFTER_UPDATE`;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `tblincrustador_PROC_AFTER_UPDATE`(IN _id INT(11))
BEGIN
 update  tblincrustador set guid=uuid() where (guid is null  or guid='') and IDincrustador=_id;
 END
;;
DELIMITER ;

-- ----------------------------
--  Procedure definition for `tblincrustador_PROC_CAMPODISPLAY`
-- ----------------------------
DROP PROCEDURE IF EXISTS `tblincrustador_PROC_CAMPODISPLAY`;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `tblincrustador_PROC_CAMPODISPLAY`(IN _id INT(11))
BEGIN
  UPDATE tblincrustador SET CAMPODISPLAY=CONCAT(' ',IDincrustador,'-','-',ifnull(IDSYSCOMPONENT,''),'-',ifnull(TABLA,''),'-',ifnull(CAMPO,'')) WHERE IDincrustador=_id;
...
-- ----------------------------
--  Procedure definition for `tblincrustador_PROC_PROCESADOR1`
-- ----------------------------
DROP PROCEDURE IF EXISTS `tblincrustador_PROC_PROCESADOR1`;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `tblincrustador_PROC_PROCESADOR1`(IN _id INT(11))
BEGIN
 END
;;
DELIMITER ;
...
-- ----------------------------
--  Procedure definition for `tblincrustador_PROC_PROCESADOR2`
-- ----------------------------
DROP PROCEDURE IF EXISTS `tblincrustador_PROC_PROCESADOR2`;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `tblincrustador_PROC_PROCESADOR2`(IN _id INT(11))
BEGIN
 END
;;
DELIMITER ;
...
-- ----------------------------
--  Procedure definition for `tblincrustador_PROC_PROCESADOR3`
-- ----------------------------
DROP PROCEDURE IF EXISTS `tblincrustador_PROC_PROCESADOR3`;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `tblincrustador_PROC_PROCESADOR3`(IN _id INT(11))
BEGIN
 END
;;
DELIMITER ;
...
-- ----------------------------
--  Procedure definition for `tblincrustador_PROC_PROCESADOR4`
-- ----------------------------
DROP PROCEDURE IF EXISTS `tblincrustador_PROC_PROCESADOR4`;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `tblincrustador_PROC_PROCESADOR4`(IN _id INT(11))
BEGIN
 END
;;
DELIMITER ;
...
-- ----------------------------
--  Procedure definition for `tblincrustador_PROC_PROCESADOR5`
-- ----------------------------
DROP PROCEDURE IF EXISTS `tblincrustador_PROC_PROCESADOR5`;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `tblincrustador_PROC_PROCESADOR5`(IN _id INT(11))
BEGIN
 END
;;
DELIMITER ;
...
-- ----------------------------
--  Procedure definition for `tblincrustador_PROC_REFRESCADOR`
-- ----------------------------
DROP PROCEDURE IF EXISTS `tblincrustador_PROC_REFRESCADOR`;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `tblincrustador_PROC_REFRESCADOR`(IN _id INT(11))
BEGIN
 END
;;
DELIMITER ;
...
-- ----------------------------
--  Procedure definition for `tblsyscomponent_PROC_AFTER_INSERT`
-- ----------------------------
DROP PROCEDURE IF EXISTS `tblsyscomponent_PROC_AFTER_INSERT`;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `tblsyscomponent_PROC_AFTER_INSERT`(IN _id INT(11))
BEGIN
 END
;;
DELIMITER ;
...
-- ----------------------------
--  Procedure definition for `tblsyscomponent_PROC_AFTER_UPDATE`
-- ----------------------------
DROP PROCEDURE IF EXISTS `tblsyscomponent_PROC_AFTER_UPDATE`;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `tblsyscomponent_PROC_AFTER_UPDATE`(IN _id INT(11))
BEGIN
 update  tblsyscomponent set guid=uuid() where (guid is null  or guid='') and IDsyscomponent=_id;
 END
;;
DELIMITER ;

-- ----------------------------
--  Procedure definition for `tblsyscomponent_PROC_CAMPODISPLAY`
-- ----------------------------
DROP PROCEDURE IF EXISTS `tblsyscomponent_PROC_CAMPODISPLAY`;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `tblsyscomponent_PROC_CAMPODISPLAY`(IN _id INT(11))
BEGIN
  UPDATE tblsyscomponent SET CAMPODISPLAY=CONCAT(' ',IDsyscomponent,'-','-',ifnull(COMPONENTE,''),'-',ifnull(TEMPLATE,''),'-',ifnull(AUXILIAR1_char,'')) WHERE IDsyscomponent=_id;
...
-- ----------------------------
--  Procedure definition for `tblsyscomponent_PROC_PROCESADOR1`
-- ----------------------------
DROP PROCEDURE IF EXISTS `tblsyscomponent_PROC_PROCESADOR1`;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `tblsyscomponent_PROC_PROCESADOR1`(IN _id INT(11))
BEGIN
 END
;;
DELIMITER ;
...
-- ----------------------------
--  Procedure definition for `tblsyscomponent_PROC_PROCESADOR2`
-- ----------------------------
DROP PROCEDURE IF EXISTS `tblsyscomponent_PROC_PROCESADOR2`;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `tblsyscomponent_PROC_PROCESADOR2`(IN _id INT(11))
BEGIN
 END
;;
DELIMITER ;
...
-- ----------------------------
--  Procedure definition for `tblsyscomponent_PROC_PROCESADOR3`
-- ----------------------------
DROP PROCEDURE IF EXISTS `tblsyscomponent_PROC_PROCESADOR3`;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `tblsyscomponent_PROC_PROCESADOR3`(IN _id INT(11))
BEGIN
 END
;;
DELIMITER ;
...
-- ----------------------------
--  Procedure definition for `tblsyscomponent_PROC_PROCESADOR4`
-- ----------------------------
DROP PROCEDURE IF EXISTS `tblsyscomponent_PROC_PROCESADOR4`;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `tblsyscomponent_PROC_PROCESADOR4`(IN _id INT(11))
BEGIN
 END
;;
DELIMITER ;
...
-- ----------------------------
--  Procedure definition for `tblsyscomponent_PROC_PROCESADOR5`
-- ----------------------------
DROP PROCEDURE IF EXISTS `tblsyscomponent_PROC_PROCESADOR5`;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `tblsyscomponent_PROC_PROCESADOR5`(IN _id INT(11))
BEGIN
 END
;;
DELIMITER ;
...
-- ----------------------------
--  Procedure definition for `tblsyscomponent_PROC_REFRESCADOR`
-- ----------------------------
DROP PROCEDURE IF EXISTS `tblsyscomponent_PROC_REFRESCADOR`;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `tblsyscomponent_PROC_REFRESCADOR`(IN _id INT(11))
BEGIN
 END
;;
DELIMITER ;

<script>
$(document).ready(function () { $("#IDSYSBUILD").on("change", 
 function (event) { 
 // var type = event.args.type; // keyboard, mouse or null depending on how the value was changed. 
   // var value = $("#IDSYSBUILD").val(); 
 });}); 

 $(document).ready(function () { $("#TABLENAME").on("change", 
 function (event) { 
 // var type = event.args.type; // keyboard, mouse or null depending on how the value was changed. 
   // var value = $("#TABLENAME").val(); 
 });}); 

 $(document).ready(function () { $("#BUILD").on("change", 
 function (event) { 
 // var type = event.args.type; // keyboard, mouse or null depending on how the value was changed. 
   // var value = $("#BUILD").val(); 
 });}); 

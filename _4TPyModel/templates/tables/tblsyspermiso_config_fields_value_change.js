<script>
$(document).ready(function () { $("#IDSYSPERMISO").on("change", 
 function (event) { 
 // var type = event.args.type; // keyboard, mouse or null depending on how the value was changed. 
   // var value = $("#IDSYSPERMISO").val(); 
 });}); 
 ...
 $(document).ready(function () { $("#ACCESO").on("change", 
 function (event) { 
 // var type = event.args.type; // keyboard, mouse or null depending on how the value was changed. 
   // var value = $("#ACCESO").val(); 
 });}); 

 $(document).ready(function () { $("#MODIFICAR").on("change", 
 function (event) { 
 // var type = event.args.type; // keyboard, mouse or null depending on how the value was changed. 
   // var value = $("#MODIFICAR").val(); 
 });}); 

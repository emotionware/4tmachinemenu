...
$(document).ready(function () { $("#IDPRODUCTIVIDAD").on("change", 

 function (event) { 

 // var type = event.args.type; // keyboard, mouse or null depending on how the value was changed. 

   // var value = $("#IDPRODUCTIVIDAD").val(); 
...
//    var value = $("#IDSYSUSER").val();     alert (value.value);
 ...
 $(document).ready(function () { $("#USERNAME").on("change", 
 ...
 $(document).ready(function () { $("#ACCION").on("change", 
 ...
 $(document).ready(function () { $("#HORA").on("change", 

<script>
$(document).ready(function () { $("#IDFLOWPROCCDETA").on("change", 
 function (event) { 
 // var type = event.args.type; // keyboard, mouse or null depending on how the value was changed. 
   // var value = $("#IDFLOWPROCCDETA").val(); 
 });}); 

 $(document).ready(function () { $("#IDFLOWPROCC").on("change", 
 function (event) { 
 // var type = event.args.type; // keyboard, mouse or null depending on how the value was changed. 
   // var value = $("#IDFLOWPROCC").val(); 
 });}); 
 ...
 $(document).ready(function () { $("#URL_ETAPA").on("change", 
 function (event) { 
 // var type = event.args.type; // keyboard, mouse or null depending on how the value was changed. 
   // var value = $("#URL_ETAPA").val(); 
 });}); 

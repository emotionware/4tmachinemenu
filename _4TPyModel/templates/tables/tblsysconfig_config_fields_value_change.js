<script>
$(document).ready(function () { $("#IDSYSCONFIG").on("change", 
 function (event) { 
 // var type = event.args.type; // keyboard, mouse or null depending on how the value was changed. 
   // var value = $("#IDSYSCONFIG").val(); 
 });}); 

 $(document).ready(function () { $("#CONCEPT").on("change", 
 function (event) { 
 // var type = event.args.type; // keyboard, mouse or null depending on how the value was changed. 
   // var value = $("#CONCEPT").val(); 
 });}); 

 $(document).ready(function () { $("#VALUE").on("change", 
 function (event) { 
 // var type = event.args.type; // keyboard, mouse or null depending on how the value was changed. 
   // var value = $("#VALUE").val(); 
 });}); 

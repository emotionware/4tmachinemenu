<script>
$(document).ready(function () { $("#IDSYSMASTERDETAIL").on("change", 
 function (event) { 
 // var type = event.args.type; // keyboard, mouse or null depending on how the value was changed. 
   // var value = $("#IDSYSMASTERDETAIL").val(); 
 });}); 

 $(document).ready(function () { $("#MASTER").on("change", 
 function (event) { 
 // var type = event.args.type; // keyboard, mouse or null depending on how the value was changed. 
   // var value = $("#MASTER").val(); 
 });}); 

 $(document).ready(function () { $("#DETAIL").on("change", 
 function (event) { 
 // var type = event.args.type; // keyboard, mouse or null depending on how the value was changed. 

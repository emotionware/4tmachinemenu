<script>
$(document).ready(function () { $("#IDSYSREPORT").on("change", 
 function (event) { 
 // var type = event.args.type; // keyboard, mouse or null depending on how the value was changed. 
   // var value = $("#IDSYSREPORT").val(); 
 });}); 

 $(document).ready(function () { $("#IDSYSTIPOREPORTE").on("change", 
 function (event) { 
 // var type = event.args.type; // keyboard, mouse or null depending on how the value was changed. 
   // var value = $("#IDSYSTIPOREPORTE").val(); 
 });}); 
 ...
 $(document).ready(function () { $("#URLDESIGN").on("change", 
 function (event) { 
 // var type = event.args.type; // keyboard, mouse or null depending on how the value was changed. 
   // var value = $("#URLDESIGN").val(); 
 });}); 

 $(document).ready(function () { $("#URLVIEWER").on("change", 
 function (event) { 
 // var type = event.args.type; // keyboard, mouse or null depending on how the value was changed. 
   // var value = $("#URLVIEWER").val(); 
 });}); 
